...
- Wait briefly for concurrent SQLite writers instead of failing usage event
  recording with `database is locked` when multiple Pi agents share the ledger.

## [0.2.2] - 2026-07-17

### Changed

- Update the development compatibility baseline to Pi 0.80.10 across
...
[Unreleased]: https://github.com/ttiimmaahh/pi-usage-bar/compare/v0.2.3...HEAD
[0.2.3]: https://github.com/ttiimmaahh/pi-usage-bar/compare/v0.2.2...v0.2.3
[0.2.2]: https://github.com/ttiimmaahh/pi-usage-bar/compare/v0.2.1...v0.2.2
